...
HeliosLinT64Test subclass source code.

Date Created: Mon Jan 11 16:32:47 MST 2016
...
const std::vector<std::string> HeliosLinT64Test::helios_aurora_03_inputs_ = {
R"(+SET management.
!/////////////////////////////////////////////////////////////////////////////!
...
const std::vector<std::string> HeliosLinT64Test::helios_aurora_31_inputs_ = {
R"(+HELIOS input (almost "short").

!%= aurora-03.hrf !

'BWR-4x4' = CASE( 'hy049n18g201_linT64.dat' / 'aurora-31.hrf' /
...
const std::vector<std::string> HeliosLinT64Test::helios_zenith_31_inputs_ = {
R"(!%=zenith-31.hrf
!%=aurora-03.hrf
!
...
void HeliosLinT64Test::runTest() {
  std::string cmd_result;
  std::string script_cmd_result;
  std::string helios_dir;
//  std::cout << "Execute runTest member function from HeliosLinT64Test object " << __FILE__ << "\t" <<__LINE__ << std::endl;
  if (!flog_.is_open()) {
